...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/Waldo60/testeo/main/MultiGen/VPS-MX/install/Control-IP")
  [[ $(echo $permited|grep "${IP}") = "" ]] && {
  echo -e "\n\n\n\033[1;31m====================================================="
  echo -e "\033[1;31m       ¡LA IP $(wget -qO- ipv4.icanhazip.com) NO ESTA AUTORIZADA!"
  echo -e "\033[1;31m                CONTACTE A @Thony Stark"
  echo -e "\033[1;31m=====================================================\n\n\n"
  [[ -d /etc/SCRIPT ]] && rm -rf /etc/SCRIPT
  exit 1
  } || {
  ### INTALAR VERCION DE SCRIPT
  v1=$(curl -sSL "https://raw.githubusercontent.com/Waldo60/testeo/main/MultiGen/VPS-MX/install/Vercion")
...
wget https://raw.githubusercontent.com/Waldo60/testeo/main/MultiGen/VPS-MX/gerador/gerar.sh &>/dev/null
...
wget -O /var/www/html/instalscript.sh https://raw.githubusercontent.com/Waldo60/testeo/main/VPS-MX/instalscript.sh &>/dev/null
